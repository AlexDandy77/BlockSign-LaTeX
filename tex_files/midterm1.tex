...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/landing-top.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/login-crop.png"}}
    \caption{Login page}
    \label{login}
\end{figure}

It also contains a \textbf{``Forgot password?''} option to help users recover their credentials securely. 
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/registerstep2.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/successregister.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/documentspage1-crop.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/success-crop.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/unsuccess-crop.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/documentspage2-crop.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/accountspage-account-protection.png"}}
    \caption{Account page - Possibility to modify personal info and protection methods}
    \label{accountspage-account-protection}
\end{figure}

The protection tab provides the possibility to change password and enable multi-factor authentication. 
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/figmaUI/accountspage-documents-crop.png"}}
