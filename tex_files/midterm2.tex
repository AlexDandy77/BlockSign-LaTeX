...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/codeMail.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/register.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/thankYou.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/mnemonicLogin.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/headerAccountUser.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/headerAccountAdmin.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/adminConsole.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/adminConsoleNoRequests.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/finishRegMail.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/mnemonicPhrase.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/securityMethod.png"}}
    \caption{Security Method Selection}
    \label{security-method}
\end{figure}

The PIN-code is a shorter way to access the account and site functionality to avoid using the mnemonic phrase every time (Figure \ref{pin-for-site}). 

\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/pinForSite.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=18cm]{"images/siteUI/logedIn.png"}}
