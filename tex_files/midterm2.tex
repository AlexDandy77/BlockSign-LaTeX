...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/main-project-routers.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/user-db-model.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/email-sending.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/keygen.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/payload-signature.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/code.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/codeMail.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/register.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/thankYou.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/mnemonicLogin.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/headerAccountUser.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/headerAccountAdmin.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/adminConsole.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/adminConsoleNoRequests.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/finishRegMail.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/mnemonicPhrase.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/securityMethod.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/pinForSite.png"}}
...
\begin{figure}[H]
    \centering
    \adjustbox{fbox,center}{\includegraphics[width=17cm]{"images/siteUI/logedIn.png"}}
